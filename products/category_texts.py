...
POSTDOZEN = 'Postdozen met klepsluiting of bovenklep zijn uitermate geschikt voor webshops. De dozen zijn eenvoudig uit te vouwen en af te sluiten. Postdozen komen vaak met zelfklevende sluit- en retourstrip.'
GESCHENKDOZEN = 'Onder geschenkdozen vallen de feestelijk bedrukte verzenddoosjes. Denk aan dozen met een kerst of sinterklaas thema'
...
GONDELDOZEN = 'De gondeldoos is een veelzijdige geschenkverpakking in een opvallende gondelvorm. De doosjes zijn eenvoudig open te vouwen, te vullen en weer af te sluiten.'
MAGNEETDOZEN = 'Magneetdozen zijn luxe geschenkverpakkingen met een magneetsluiting.'
BIERDOZEN = 'Bierdozen zijn vouwdozen speciaal gemaakt om bierflesjes in te verpakken.'
WIJNDOZEN = 'Wijndozen hebben precies de juiste afmeting voor een bepaalde hoeveelheid wijnflessen. De dozen worden vaak voorzien van een (niet bijgeleverd) insert die de flessen extra bescherming bieden.'
